...
(1, 'admin', 'Admin', '810b992b9b93e4024b4c844702782a09', 'ca47d9', 'http://ec.cn/assets/img/avatar.png', 'admin@admin.com', '', 0, 1704360867, '127.0.0.1', 1491635035, 1704360867, 'd20b9616-3802-4d77-8717-41ce2fa52595', 'normal');
...
(1, 1, 'admin', '/eMqycsvjkx.php/index/login', '登录', '{\"__token__\":\"***\",\"username\":\"admin\",\"password\":\"***\",\"captcha\":\"wryq\"}', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:121.0) Gecko/20100101 Firefox/121.0', 1704360772),
(2, 1, 'admin', '/index/login', '登录', '{\"__token__\":\"***\",\"username\":\"admin\",\"password\":\"***\",\"captcha\":\"RSE7\"}', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:121.0) Gecko/20100101 Firefox/121.0', 1704360867),
(3, 1, 'admin', '/addon/install', '插件管理', '{\"name\":\"unishop\",\"force\":\"0\",\"uid\":\"33821\",\"token\":\"***\",\"version\":\"2.3.0\",\"faversion\":\"1.4.0.20230711\"}', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:121.0) Gecko/20100101 Firefox/121.0', 1704360892),
(4, 1, 'admin', '/addon/state', '插件管理 / 禁用启用', '{\"name\":\"unishop\",\"action\":\"enable\",\"force\":\"0\"}', '127.0.0.1', 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10.15; rv:121.0) Gecko/20100101 Firefox/121.0', 1704360892);
...
(85, 'file', 0, 'unishop', 'uniShop移动商城', 'fa fa-font-awesome', '', '', '', 1, NULL, '', 'uydsc', 'uniShopyidongshangcheng', 1704360889, 1704360889, 0, 'normal'),
(86, 'file', 85, 'unishop/ads', '广告图管理', 'fa fa-buysellads', '', '', '', 1, NULL, '', 'ggtgl', 'guanggaotuguanli', 1704360889, 1704360889, 0, 'normal'),
(87, 'file', 86, 'unishop/ads/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(88, 'file', 86, 'unishop/ads/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1704360889, 1704360889, 0, 'normal'),
(89, 'file', 86, 'unishop/ads/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1704360889, 1704360889, 0, 'normal'),
(90, 'file', 86, 'unishop/ads/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(91, 'file', 86, 'unishop/ads/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1704360889, 1704360889, 0, 'normal'),
(92, 'file', 85, 'unishop/category', '分类管理', 'fa fa-align-justify', '', '', '注意：产品只支持二级分类。', 1, NULL, '', 'flgl', 'fenleiguanli', 1704360889, 1704360889, 0, 'normal'),
(93, 'file', 92, 'unishop/category/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(94, 'file', 92, 'unishop/category/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(95, 'file', 92, 'unishop/category/edit', '修改', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'xg', 'xiugai', 1704360889, 1704360889, 0, 'normal'),
(96, 'file', 92, 'unishop/category/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1704360889, 1704360889, 0, 'normal'),
(97, 'file', 92, 'unishop/category/multi', '批量操作', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plcz', 'piliangcaozuo', 1704360889, 1704360889, 0, 'normal'),
(98, 'file', 85, 'unishop/product', '产品管理', 'fa fa-product-hunt', '', '', '', 1, NULL, '', 'cpgl', 'chanpinguanli', 1704360889, 1704360889, 0, 'normal'),
(99, 'file', 98, 'unishop/product/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(100, 'file', 98, 'unishop/product/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1704360889, 1704360889, 0, 'normal'),
(101, 'file', 98, 'unishop/product/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1704360889, 1704360889, 0, 'normal'),
(102, 'file', 98, 'unishop/product/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(103, 'file', 98, 'unishop/product/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1704360889, 1704360889, 0, 'normal'),
(104, 'file', 98, 'unishop/product/recyclebin', '回收站', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hsz', 'huishouzhan', 1704360889, 1704360889, 0, 'normal'),
(105, 'file', 98, 'unishop/product/destroy', '真是删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zssc', 'zhenshishanchu', 1704360889, 1704360889, 0, 'normal'),
(106, 'file', 98, 'unishop/product/restore', '还原', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hy', 'huanyuan', 1704360889, 1704360889, 0, 'normal'),
(107, 'file', 98, 'unishop/product/copy', '复制', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'fz', 'fuzhi', 1704360889, 1704360889, 0, 'normal'),
(108, 'file', 85, 'unishop/delivery', '运费模板', 'fa fa-delicious', '', '', '', 1, NULL, '', 'yfmb', 'yunfeimuban', 1704360889, 1704360889, 0, 'normal'),
(109, 'file', 108, 'unishop/delivery/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(110, 'file', 108, 'unishop/delivery/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1704360889, 1704360889, 0, 'normal'),
(111, 'file', 108, 'unishop/delivery/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1704360889, 1704360889, 0, 'normal'),
(112, 'file', 108, 'unishop/delivery/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(113, 'file', 108, 'unishop/delivery/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1704360889, 1704360889, 0, 'normal'),
(114, 'file', 85, 'unishop/config', '系统配置', 'fa fa-certificate', '', '', '更新配置缓存不会立即生效，如需立即生效请清空缓存。', 1, NULL, '', 'xtpz', 'xitongpeizhi', 1704360889, 1704360889, 0, 'normal'),
(115, 'file', 114, 'unishop/config/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(116, 'file', 114, 'unishop/config/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1704360889, 1704360889, 0, 'normal'),
(117, 'file', 114, 'unishop/config/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1704360889, 1704360889, 0, 'normal'),
(118, 'file', 114, 'unishop/config/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(119, 'file', 114, 'unishop/config/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1704360889, 1704360889, 0, 'normal'),
(120, 'file', 85, 'unishop/market', '营销中心', 'fa fa-list', '', '', '', 1, NULL, '', 'yxzx', 'yingxiaozhongxin', 1704360889, 1704360889, 0, 'normal'),
(121, 'file', 120, 'unishop/market/coupon', '优惠券管理', 'fa fa-gratipay', '', '', '', 1, NULL, '', 'yhqgl', 'youhuiquanguanli', 1704360889, 1704360889, 0, 'normal'),
(122, 'file', 121, 'unishop/market/coupon/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(123, 'file', 121, 'unishop/market/coupon/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1704360889, 1704360889, 0, 'normal'),
(124, 'file', 121, 'unishop/market/coupon/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1704360889, 1704360889, 0, 'normal'),
(125, 'file', 121, 'unishop/market/coupon/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(126, 'file', 121, 'unishop/market/coupon/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1704360889, 1704360889, 0, 'normal'),
(127, 'file', 121, 'unishop/market/coupon/recyclebin', '回收站', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hsz', 'huishouzhan', 1704360889, 1704360889, 0, 'normal'),
(128, 'file', 121, 'unishop/market/coupon/destroy', '真实删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zssc', 'zhenshishanchu', 1704360889, 1704360889, 0, 'normal'),
(129, 'file', 121, 'unishop/market/coupon/restore', '还原', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hy', 'huanyuan', 1704360889, 1704360889, 0, 'normal'),
(130, 'file', 120, 'unishop/market/flash_sale', '秒杀管理', 'fa fa-flag', '', '', '1，归档结束会把商品的真实售量和剩余数量同步到对应商品。\n2，已归档、已开始、上架状态的秒杀信息不能够修改。\n3，商品列表下架的商品也可以参与秒杀，建议复制一份商品专门提供给秒杀使用。\n4，秒杀进行中的商品可以单个下架。\n5，必须启动redis才能使用秒杀功能', 1, NULL, '', 'msgl', 'miaoshaguanli', 1704360889, 1704360889, 0, 'normal'),
(131, 'file', 130, 'unishop/market/flash_sale/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(132, 'file', 130, 'unishop/market/flash_sale/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1704360889, 1704360889, 0, 'normal'),
(133, 'file', 130, 'unishop/market/flash_sale/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1704360889, 1704360889, 0, 'normal'),
(134, 'file', 130, 'unishop/market/flash_sale/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(135, 'file', 130, 'unishop/market/flash_sale/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1704360889, 1704360889, 0, 'normal'),
(136, 'file', 130, 'unishop/market/flash_sale/recyclebin', '回收站', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hsz', 'huishouzhan', 1704360889, 1704360889, 0, 'normal'),
(137, 'file', 130, 'unishop/market/flash_sale/destroy', '真实删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zssc', 'zhenshishanchu', 1704360889, 1704360889, 0, 'normal'),
(138, 'file', 130, 'unishop/market/flash_sale/restroy', '还原', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hy', 'huanyuan', 1704360889, 1704360889, 0, 'normal'),
(139, 'file', 130, 'unishop/market/flash_product/multi', '更新秒杀产品状态', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'gxmscpzt', 'gengxinmiaoshachanpinzhuangtai', 1704360889, 1704360889, 0, 'normal'),
(140, 'file', 85, 'unishop/order', '订单管理', 'fa fa-print', '', '', '1，货到付款默认支付状态为已支付，请留意发快递的时候选择收付模式。', 1, NULL, '', 'ddgl', 'dingdanguanli', 1704360889, 1704360889, 0, 'normal'),
(141, 'file', 140, 'unishop/order/delivery', '物流管理', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'wlgl', 'wuliuguanli', 1704360889, 1704360889, 0, 'normal'),
(142, 'file', 140, 'unishop/order/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1704360889, 1704360889, 0, 'normal'),
(143, 'file', 140, 'unishop/order/restore', '还原', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hy', 'huanyuan', 1704360889, 1704360889, 0, 'normal'),
(144, 'file', 140, 'unishop/order/destroy', '真实删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zssc', 'zhenshishanchu', 1704360889, 1704360889, 0, 'normal'),
(145, 'file', 140, 'unishop/order/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(146, 'file', 140, 'unishop/order/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1704360889, 1704360889, 0, 'normal'),
(147, 'file', 140, 'unishop/order/recyclebin', '回收站', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hsz', 'huishouzhan', 1704360889, 1704360889, 0, 'normal'),
(148, 'file', 140, 'unishop/order/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(149, 'file', 140, 'unishop/order/product', '商品管理', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'spgl', 'shangpinguanli', 1704360889, 1704360889, 0, 'normal'),
(150, 'file', 140, 'unishop/order/refund', '退货', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'th', 'tuihuo', 1704360889, 1704360889, 0, 'normal'),
(151, 'file', 85, 'unishop/evaluate', '商品评价管理', 'fa fa-commenting', '', '', '', 1, NULL, '', 'sppjgl', 'shangpinpingjiaguanli', 1704360889, 1704360889, 0, 'normal'),
(152, 'file', 151, 'unishop/evaluate/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(153, 'file', 151, 'unishop/evaluate/recyclebin', '回收站', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hsz', 'huishouzhan', 1704360889, 1704360889, 0, 'normal'),
(154, 'file', 151, 'unishop/evaluate/add', '添加', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'tj', 'tianjia', 1704360889, 1704360889, 0, 'normal'),
(155, 'file', 151, 'unishop/evaluate/edit', '编辑', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'bj', 'bianji', 1704360889, 1704360889, 0, 'normal'),
(156, 'file', 151, 'unishop/evaluate/del', '删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'sc', 'shanchu', 1704360889, 1704360889, 0, 'normal'),
(157, 'file', 151, 'unishop/evaluate/destroy', '真实删除', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zssc', 'zhenshishanchu', 1704360889, 1704360889, 0, 'normal'),
(158, 'file', 151, 'unishop/evaluate/restore', '还原', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'hy', 'huanyuan', 1704360889, 1704360889, 0, 'normal'),
(159, 'file', 151, 'unishop/evaluate/multi', '批量更新', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'plgx', 'pilianggengxin', 1704360889, 1704360889, 0, 'normal'),
(160, 'file', 85, 'unishop/dashboard', '仪表盘统计', 'fa fa-dashboard', '', '', '', 1, NULL, '', 'ybptj', 'yibiaopantongji', 1704360889, 1704360889, 0, 'normal'),
(161, 'file', 160, 'unishop/dashboard/index', '查看', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'zk', 'zhakan', 1704360889, 1704360889, 0, 'normal'),
(162, 'file', 160, 'unishop/dashboard/income', '营收统计', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'ystj', 'yingshoutongji', 1704360889, 1704360889, 0, 'normal'),
(163, 'file', 160, 'unishop/dashboard/goods', '商品销量', 'fa fa-circle-o', '', '', '', 0, NULL, '', 'spxl', 'shangpinxiaoliang', 1704360890, 1704360890, 0, 'normal');
...
(1, 'name', 'basic', 'Site name', '请填写站点名称', 'string', '', '积分商城', '', 'required', '', ''),
...
--
-- 表的结构 `fa_unishop_address`
--

CREATE TABLE `fa_unishop_address` (
  `id` int(10) NOT NULL,
...
CREATE TABLE `fa_unishop_ads` (
  ...
  `createtime` bigint(16) NOT NULL COMMENT '创建时间',
  `updatetime` bigint(16) NOT NULL COMMENT '更新时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='广告图管理';

-- --------------------------------------------------------

--
-- 表的结构 `fa_unishop_area`
--

CREATE TABLE `fa_unishop_area` (
  `id` int(10) NOT NULL COMMENT 'ID',
  `pid` int(10) DEFAULT NULL COMMENT '父id',
  `shortname` varchar(100) DEFAULT NULL COMMENT '简称',
  `name` varchar(100) DEFAULT NULL COMMENT '名称',
...
--
-- 转存表中的数据 `fa_unishop_area`
--

INSERT INTO `fa_unishop_area` (`id`, `pid`, `shortname`, `name`, `mergename`, `level`, `pinyin`, `code`, `zip`, `first`, `lng`, `lat`) VALUES
...
--
-- 表的结构 `fa_unishop_cart`
--

CREATE TABLE `fa_unishop_cart` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
...
--
-- 表的结构 `fa_unishop_category`
--

CREATE TABLE `fa_unishop_category` (
  `id` int(10) UNSIGNED NOT NULL,
  `pid` int(10) UNSIGNED NOT NULL DEFAULT '0' COMMENT '父ID',
...
--
-- 表的结构 `fa_unishop_config`
--

CREATE TABLE `fa_unishop_config` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- 转存表中的数据 `fa_unishop_config`
--

INSERT INTO `fa_unishop_config` (`id`, `name`, `group`, `title`, `tip`, `type`, `value`, `content`, `rule`, `extend`) VALUES
(1, 'name', 'basic', 'Site name', '请填写站点名称', 'string', 'uniSHOP', '', 'required', ''),
(9, 'categorytype', 'dictionary', 'Category type', '', 'array', '{\"default\":\"Default\",\"page\":\"Page\",\"article\":\"Article\",\"test\":\"Test\"}', '', '', ''),
(10, 'configgroup', 'dictionary', 'Config group', '', 'array', '{\"basic\":\"基础配置\",\"dictionary\":\"字典配置\",\"wechat\":\"微信配置\",\"ali\":\"支付宝配置\",\"express\":\"物流配置\"}', '', '', ''),
...
(21, 'notify_url', 'wechat', '订单回调地址', '', 'string', 'https://www.example.com/addons/unishop/pay/notify', '', '', ''),
...
(27, 'avatar', 'basic', '默认头像', '', 'image', '/assets/addons/unishop/image/avatar.png', '', '', ''),
(28, 'ali_app_id', 'ali', '支付宝appid', '', 'string', '2016102400750248', '', '', ''),
(29, 'ali_notify_url', 'ali', '通知地址', '', 'string', 'https://www.example.com/addons/unishop/pay/alinotify', '', '', ''),
(30, 'ali_return_url', 'ali', '返回地址', '', 'string', 'https://www.example.com/h5/#/pages/order/order?state=0', '', '', ''),
...
(34, 'ali_express_app_code', 'express', '阿里云APPCODE', '', 'string', '', '', '', ''),
(35, 'ali_express_cache', 'express', '物流缓存（分钟）', '', 'number', '600', '', '', '');

-- --------------------------------------------------------

--
-- 表的结构 `fa_unishop_coupon`
--

CREATE TABLE `fa_unishop_coupon` (
  `id` int(10) NOT NULL,
...
--
-- 表的结构 `fa_unishop_delivery`
--

CREATE TABLE `fa_unishop_delivery` (
  `id` int(10) NOT NULL,
...
--
-- 表的结构 `fa_unishop_delivery_rule`
--

CREATE TABLE `fa_unishop_delivery_rule` (
  `id` int(10) NOT NULL,
...
--
-- 表的结构 `fa_unishop_evaluate`
--

CREATE TABLE `fa_unishop_evaluate` (
  `id` int(10) NOT NULL,
  `product_id` int(10) NOT NULL COMMENT '产品id',
  `user_id` int(10) NOT NULL COMMENT '用户id',
  ...
  `toptime` bigint(16) NOT NULL DEFAULT '0' COMMENT '是否置顶:0=否',
  `createtime` bigint(16) NOT NULL COMMENT '创建时间',
  `updatetime` bigint(16) NOT NULL COMMENT '更新时间',
  `deletetime` bigint(16) DEFAULT NULL COMMENT '删除时间'
...
--
-- 表的结构 `fa_unishop_favorite`
--

CREATE TABLE `fa_unishop_favorite` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `product_id` int(10) NOT NULL COMMENT '产品id',
  `snapshot` text NOT NULL COMMENT '产品快照',
...
--
-- 表的结构 `fa_unishop_flash_product`
--

CREATE TABLE `fa_unishop_flash_product` (
  `id` int(10) NOT NULL,
...
--
-- 表的结构 `fa_unishop_flash_sale`
--

CREATE TABLE `fa_unishop_flash_sale` (
  `id` int(10) NOT NULL,
  ...
  `createtime` bigint(16) NOT NULL COMMENT '创建时间',
  `updatetime` bigint(16) NOT NULL COMMENT '更新时间',
  `deletetime` bigint(16) DEFAULT NULL COMMENT '是否删除'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='秒杀表';

-- --------------------------------------------------------

--
-- 替换视图以便查看 `fa_unishop_goods`
-- （参见下面的实际视图）
--
CREATE TABLE `fa_unishop_goods` (
`date_time` bigint(16)
...
--
-- 替换视图以便查看 `fa_unishop_income`
-- （参见下面的实际视图）
--
CREATE TABLE `fa_unishop_income` (
`date_time` bigint(16)
...
--
-- 表的结构 `fa_unishop_like`
--

CREATE TABLE `fa_unishop_like` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
...
--
-- 表的结构 `fa_unishop_order`
--

CREATE TABLE `fa_unishop_order` (
...
--
-- 表的结构 `fa_unishop_order_extend`
--

CREATE TABLE `fa_unishop_order_extend` (
  `id` int(10) NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL COMMENT '用户id',
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
  `coupon_id` int(10) NOT NULL DEFAULT '0' COMMENT '优惠券id',
  `coupon_json` text COMMENT '优惠券快照',
  `delivery_id` int(10) NOT NULL DEFAULT '0' COMMENT '运费模板id',
  `delivery_json` text COMMENT '运费模板快照',
  `address_id` int(10) NOT NULL COMMENT '地址id',
  `address_json` text COMMENT '地址快照',
  `express_number` varchar(30) NOT NULL DEFAULT '' COMMENT '快递单号',
  `express_company` varchar(30) NOT NULL DEFAULT '' COMMENT '快递公司',
  `createtime` bigint(16) NOT NULL COMMENT '创建时间',
  `updatetime` bigint(16) NOT NULL COMMENT '更新时间'
...
--
-- 表的结构 `fa_unishop_order_product`
--

CREATE TABLE `fa_unishop_order_product` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(10) UNSIGNED NOT NULL COMMENT '用户id',
  ...
  `product_json` text COMMENT '商品快照',
...
--
-- 表的结构 `fa_unishop_order_refund`
--

CREATE TABLE `fa_unishop_order_refund` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
...
--
-- 表的结构 `fa_unishop_order_refund_product`
--

CREATE TABLE `fa_unishop_order_refund_product` (
  `id` int(10) NOT NULL,
  `order_id` bigint(20) NOT NULL COMMENT '订单id',
  `user_id` int(10) NOT NULL COMMENT '用户id',
...
--
-- 表的结构 `fa_unishop_product`
--

CREATE TABLE `fa_unishop_product` (
  `id` int(10) UNSIGNED NOT NULL,
  ...
  `specList` text COMMENT '规格属性',
  `specTableList` text COMMENT '规格值',
  `weigh` int(10) NOT NULL DEFAULT '0' COMMENT '权重',
...
--
-- 表的结构 `fa_unishop_reply`
--

CREATE TABLE `fa_unishop_reply` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '用户id',
  ...
  `type_id` int(10) NOT NULL COMMENT '对应类型的id',
  `createtime` bigint(16) NOT NULL COMMENT '创建时间',
  `deletetime` bigint(16) NOT NULL COMMENT '删除时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='通用评论表';

-- --------------------------------------------------------

--
-- 表的结构 `fa_unishop_user_extend`
--

CREATE TABLE `fa_unishop_user_extend` (
  `id` int(10) NOT NULL,
  `user_id` int(10) NOT NULL COMMENT '基础用户表id',
  `openid` varchar(32) NOT NULL COMMENT '微信小程序openid',
  `createtime` bigint(16) NOT NULL COMMENT '创建时间',
  `updatetime` bigint(16) NOT NULL COMMENT '更新时间',
  `session_key` varchar(100) DEFAULT NULL COMMENT '微信小程序jscode2session的session_key'
...
(1, 1, 'admin', 'admin', '4fcf8cf6a7b33c63b448ae2f8e6acc5a', '7d0585', 'admin@163.com', '13888888888', 'http://ec.cn/assets/img/avatar.png', 0, 0, '2017-04-08', '', '0.00', 0, 1, 1, 1491635035, 1491635035, '127.0.0.1', 0, '127.0.0.1', 1491635035, 0, 1491635035, '', 'normal', '');
...
--
-- 视图结构 `fa_unishop_goods`
--
DROP TABLE IF EXISTS `fa_unishop_goods`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `fa_unishop_goods`  AS SELECT `o`.`createtime` AS `date_time`, `op`.`order_id` AS `order_id`, `op`.`product_id` AS `product_id`, `op`.`number` AS `number`, `p`.`title` AS `product_name` FROM ((`fa_unishop_order` `o` join `fa_unishop_order_product` `op` on((`o`.`id` = `op`.`order_id`))) left join `fa_unishop_product` `p` on((`op`.`product_id` = `p`.`id`))) WHERE ((`o`.`status` = 1) AND (`o`.`have_paid` <> 0))  ;

-- --------------------------------------------------------

--
-- 视图结构 `fa_unishop_income`
--
DROP TABLE IF EXISTS `fa_unishop_income`;

CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `fa_unishop_income`  AS SELECT `o`.`createtime` AS `date_time`, `o`.`total_price` AS `order_amount` FROM `fa_unishop_order` AS `o` WHERE ((`o`.`status` = 1) AND (`o`.`have_paid` <> 0))  ;
...
--
-- 表的索引 `fa_unishop_address`
--
ALTER TABLE `fa_unishop_address`
  ADD PRIMARY KEY (`id`),
...
-- 表的索引 `fa_unishop_ads`
--
ALTER TABLE `fa_unishop_ads`
  ADD PRIMARY KEY (`id`),
  ADD KEY `weigh` (`weigh`,`id`);

--
-- 表的索引 `fa_unishop_area`
--
ALTER TABLE `fa_unishop_area`
  ADD PRIMARY KEY (`id`),
  ADD KEY `pid` (`pid`),
  ADD KEY `pinyin` (`pinyin`) USING BTREE;

--
-- 表的索引 `fa_unishop_cart`
--
ALTER TABLE `fa_unishop_cart`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`,`product_id`);

--
-- 表的索引 `fa_unishop_category`
--
ALTER TABLE `fa_unishop_category`
  ADD PRIMARY KEY (`id`),
  ADD KEY `weigh` (`weigh`,`id`),
  ADD KEY `pid` (`pid`);

--
-- 表的索引 `fa_unishop_config`
--
ALTER TABLE `fa_unishop_config`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `name` (`name`);

--
-- 表的索引 `fa_unishop_coupon`
--
ALTER TABLE `fa_unishop_coupon`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `fa_unishop_delivery`
--
ALTER TABLE `fa_unishop_delivery`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`id`);

--
-- 表的索引 `fa_unishop_delivery_rule`
--
ALTER TABLE `fa_unishop_delivery_rule`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`id`),
  ADD KEY `delivery_id` (`delivery_id`);

--
-- 表的索引 `fa_unishop_evaluate`
--
ALTER TABLE `fa_unishop_evaluate`
  ADD PRIMARY KEY (`id`),
...
--
-- 表的索引 `fa_unishop_favorite`
--
ALTER TABLE `fa_unishop_favorite`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `product_id` (`user_id`,`product_id`) USING BTREE;

--
-- 表的索引 `fa_unishop_flash_product`
--
ALTER TABLE `fa_unishop_flash_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `flash_id` (`flash_id`);

--
-- 表的索引 `fa_unishop_flash_sale`
--
ALTER TABLE `fa_unishop_flash_sale`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `fa_unishop_like`
--
ALTER TABLE `fa_unishop_like`
  ADD PRIMARY KEY (`id`);

--
-- 表的索引 `fa_unishop_order`
--
ALTER TABLE `fa_unishop_order`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `order_no` (`out_trade_no`),
  ADD KEY `user_id` (`user_id`);

--
-- 表的索引 `fa_unishop_order_extend`
--
ALTER TABLE `fa_unishop_order_extend`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order_id` (`order_id`);

--
-- 表的索引 `fa_unishop_order_product`
--
ALTER TABLE `fa_unishop_order_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order` (`order_id`),
  ADD KEY `flash_id` (`flash_id`);

--
-- 表的索引 `fa_unishop_order_refund`
--
ALTER TABLE `fa_unishop_order_refund`
  ADD PRIMARY KEY (`id`),
  ADD KEY `order_id` (`order_id`),
  ADD KEY `user_id` (`user_id`);

--
-- 表的索引 `fa_unishop_order_refund_product`
--
ALTER TABLE `fa_unishop_order_refund_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `refund_id` (`refund_id`);

--
-- 表的索引 `fa_unishop_product`
--
ALTER TABLE `fa_unishop_product`
  ADD PRIMARY KEY (`id`),
  ADD KEY `class_id` (`category_id`) USING BTREE;

--
-- 表的索引 `fa_unishop_reply`
--
ALTER TABLE `fa_unishop_reply`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`);

--
-- 表的索引 `fa_unishop_user_extend`
--
ALTER TABLE `fa_unishop_user_extend`
  ADD PRIMARY KEY (`id`),
  ADD KEY `user_id` (`user_id`),
...
--
-- 使用表AUTO_INCREMENT `fa_unishop_address`
--
ALTER TABLE `fa_unishop_address`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_ads`
--
ALTER TABLE `fa_unishop_ads`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- 使用表AUTO_INCREMENT `fa_unishop_area`
--
ALTER TABLE `fa_unishop_area`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT COMMENT 'ID', AUTO_INCREMENT=3749;

--
-- 使用表AUTO_INCREMENT `fa_unishop_cart`
--
ALTER TABLE `fa_unishop_cart`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_category`
--
ALTER TABLE `fa_unishop_category`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=76;

--
-- 使用表AUTO_INCREMENT `fa_unishop_config`
--
ALTER TABLE `fa_unishop_config`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;

--
-- 使用表AUTO_INCREMENT `fa_unishop_coupon`
--
ALTER TABLE `fa_unishop_coupon`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_delivery`
--
ALTER TABLE `fa_unishop_delivery`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_delivery_rule`
--
ALTER TABLE `fa_unishop_delivery_rule`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_evaluate`
--
ALTER TABLE `fa_unishop_evaluate`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_favorite`
--
ALTER TABLE `fa_unishop_favorite`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_flash_product`
--
ALTER TABLE `fa_unishop_flash_product`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_flash_sale`
--
ALTER TABLE `fa_unishop_flash_sale`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_like`
--
ALTER TABLE `fa_unishop_like`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_order_extend`
--
ALTER TABLE `fa_unishop_order_extend`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_order_product`
--
ALTER TABLE `fa_unishop_order_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_order_refund`
--
ALTER TABLE `fa_unishop_order_refund`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_order_refund_product`
--
ALTER TABLE `fa_unishop_order_refund_product`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_product`
--
ALTER TABLE `fa_unishop_product`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- 使用表AUTO_INCREMENT `fa_unishop_reply`
--
ALTER TABLE `fa_unishop_reply`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;

--
-- 使用表AUTO_INCREMENT `fa_unishop_user_extend`
--
ALTER TABLE `fa_unishop_user_extend`
  MODIFY `id` int(10) NOT NULL AUTO_INCREMENT;
